...
(2, 'khuong', '$2y$10$VgWg2mzmUeYzMqz2F1P.sOxsws1B45lsFyjnm1cjh/TzwMT6Xfb2y', 0, 'tankhuong02@gmail.com', 2, 1),
...
(1, 'văn bản 151', 'Nội dung văn bản 1 mới cập nhật', 2, 1, '2024-11-01', 'PhieuBaoDuThi_CTB2022400193.pdf'),
...
(9, 'văn bản 6', 'hhhhhhhhhhhhhhhhhhhhhhhh', 4, 4, '2023-11-16', 'Baitap_Past_Continuous_Tense.docx'),
...
(12, 'văn bản 900', 'sfgdgfd', 3, 5, '2023-11-01', 'BaiTap_Simple_Past.rtf'),
...
(65, 'văn bản 160', 'fgf', 2, 2, '2024-05-18', ''),
(66, 'văn bản 1617777', 'hhytv', 27, 3, '2024-05-18', '');
...
--
ALTER TABLE `vanban`
  MODIFY `idvb` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;

--
-- AUTO_INCREMENT for table `vanban_chung`
--
ALTER TABLE `vanban_chung`
  MODIFY `idvb_chung` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
